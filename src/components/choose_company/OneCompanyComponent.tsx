    ...
    <div className={styles.one_company}>
        <div className={styles.one_company_wrapper}>
          ...
          <div className={styles.one_company_list_root}>
            {elem.company_root && elem.company_root.map((elem:any)=> <div className={styles.current_root}>
                <div style={{backgroundImage: `url(${elem.toLowerCase() === 'контроллёр' ? controller : elem.toLowerCase() === 'аналитик' ? analyst : executor})`}} className={styles.current_root_img}></div>
