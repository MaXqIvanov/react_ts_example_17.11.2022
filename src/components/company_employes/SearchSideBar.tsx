    ...
    <>
      <div className={styles.user_side_menu}>
        <div className={styles.user_side_menu_wrapper}>
          <div
            onClick={() => setIsSearchSideBar(!issearch_sidebar)}
            style={{ backgroundImage: `url(${close_btn})` }}
            className={styles.close_user_side_menu_btn}
          ></div>
          <div className={styles.group_body}>
            <div className={styles.group_img_user}></div>
            <div className={styles.text_field_block}>
              <div className={styles.search_side_bar_title}>Введите номер телефона сотрудника</div>
          ...
          <div className={styles.group_btn_side_bar}>
            <div className={styles.group_btn_side_bar_save_close}>
              <div onClick={() => setIsSearchSideBar(false)} className={styles.btn_cancel_side_bar}>
                <span>ОТМЕНА</span>
              </div>
              <div onClick={() => setIsAddedSideBar(true)} className={styles.btn_save_side_bar}>
