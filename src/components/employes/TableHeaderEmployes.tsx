            ...
            <TableContainer component={Paper} className="custom_table">
                <Table sx={{ minWidth: 650 }} aria-label="simple table">
                    ...
                    <TableRow>
                        ...
                        <TableCell>ФИО<div className={'border_dashed'}></div></TableCell>
                        <TableCell className={`table_cell`} align="left">Должность<div className={'border_dashed'}></div></TableCell>
                    ...
                    {rows?.length > 0 && rows.map((row:any, index: number) => (
                        ...
                        >
                            ...
                            <TableCell className={styles.custom_cell_table} style={{cursor: 'pointer', width: '30px', maxWidth: '30px'}} onClick={()=>{
                                ...
                                }} align="center"><div className={styles.btn_table}></div></TableCell>  
                        </TableRow>
                    ))}
                    </TableBody>
                </Table>
